  ...
  return (
    <Navbar maxWidth="xl" className='py-2 bg-transparent fixed'  >
      ...
      <NavbarContent className="hidden  sm:flex gap-6" justify="center">
        <NavbarItem>
          <Link
            className="bg-linear-to-r/srgb from-indigo-300 to-teal-400 py-1.5 px-4 rounded-md text-black font-bold"
            aria-current="page"
            color="foreground"
            href="#"
          >
        ...
        <Dropdown>
          <NavbarItem>
            <DropdownTrigger className="bg-linear-to-r/srgb from-indigo-300 to-teal-400 py-1.5 px-4 rounded-md text-black font-bold">
              <Button
      ...
      {/* sm navicon */}
      <NavbarContent className="sm:hidden text-black" justify="end">
        <NavbarMenuToggle />
      </NavbarContent>
      ...
      <NavbarMenu className='py-6'>
        {menuItems.map((item, index) => (
          <NavbarMenuItem key={`${item}-${index}`}>
            <Link
              className="w-full bg-linear-to-r/srgb from-indigo-300 to-teal-400 py-1.5 px-4 rounded-md text-black font-bold "
              color={
                index === 2
                  ? 'warning'
